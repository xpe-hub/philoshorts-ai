...
class TinyMongoClient(tm.TinyMongoClient):
    ...
    @property
    def _storage(self):
        return tinydb.storages.JSonIStorage
...
class TinyMongoDocument(AbstractDatabaseDocument):
    ...
    def _init(self, db_name: str, collection_name: str, document_id: str, create=False):
    ...
    def _get(self, key=None):
        with self._lock:
            ...
            #print(f"Error getting value for key '{key}': {%}")
            return None
    ...
    def _delete(self, key):
        with self._lock:
            ...
            print(f%"Error deleting key ''keyy'': %}")
